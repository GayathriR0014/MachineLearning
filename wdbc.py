...
my_batch_size = 32 # Batch size changed
my_epochs = 1000
...
#############layer 1
my_model.add(tf.keras.layers.Dense(120,input_dim = 30, kernel_initializer='uniform'))
my_model.add(tf.keras.layers.BatchNormalization()) ## to normalize after nonlinear function
my_model.add(tf.keras.layers.Activation("relu"))


#############layer 2
my_model.add(tf.keras.layers.Dense(100, kernel_initializer='uniform'))
my_model.add(tf.keras.layers.BatchNormalization()) ## to normalize after nonlinear function
my_model.add(tf.keras.layers.Activation("tanh"))
...
###########layer 4
my_model.add(tf.keras.layers.Dense(5, kernel_initializer='uniform', activation="relu"))
